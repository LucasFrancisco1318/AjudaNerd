...
<head>
    ...
    <title>Ajuda Nerd</title>

    <!-- Bootstrap core CSS -->
    <link href="/res/css/bootstrap.min1.css" rel="stylesheet">
    <link href="/res/bower_components/font-awesome/css/font-awesome.css" rel="stylesheet">
    ...
    <link href="/res/css/blog1.css" rel="stylesheet">
</head>
...
<div class="container">
    <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            <div class="col-4 pt-1">
                <a class="blog-header-logo text-dark" href="#">Ajuda Nerd</a>
            </div>
            <div class="col-4 text-center">
            </div>
            <div class="col-4 d-flex justify-content-end align-items-center">

                <a class="btn btn-sm btn-outline-secondary" href="/login"> <i class="fas fa-sign-in-alt"></i> Login</a>
            </div>
        </div>
    </header>
    ...
    <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
            <a class="p-2 text-muted" href="/book"> <i class="fas fa-book"></i> Livros</a>
            <a class="p-2 text-muted" href="#"> <i class="fas fa-newspaper"></i> Lançamentos</a>
            <a class="p-2 text-muted" href="#"> <i class="fas fa-cloud-download-alt"></i> Livros mais Baixados</a>
            <a class="p-2 text-muted" href="#"> <i class="fas fa-money-bill-alt"></i> Seja um Nerd PRO</a>
            <a class="p-2 text-muted" href="#"> <i class="fas fa-info"></i> Sobre</a>
        </nav>
    </div>
