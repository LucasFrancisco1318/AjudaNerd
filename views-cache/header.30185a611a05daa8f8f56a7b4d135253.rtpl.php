...
<head>
    ...
    <link rel="stylesheet" href="/res/css/photo.css">
    <!-- Theme style -->
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <?php echo getUserName(); ?> - <?php echo getUserProfession(); ?>
                                    <small>Membro desde <?php echo getFormatDate(); ?></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    <a href="#"><i class="fa fa-circle text-success"></i> <?php echo getUserProfession(); ?></a>
                </div>
            </div>
            <!-- search form -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/users/create"><i class="fas fa-plus"></i> Cadastrar</a></li>
                        <li><a href="/admin/users"><i class="fas fa-list-ul"></i> Listar</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/books/create"><i class="fas fa-plus"></i> Cadastrar</a></li>
                        <li><a href="/admin/books"><i class="fas fa-list-ul"></i> Listar</a></li>
                    </ul>
                </li>

                <li class="treeview">
                    <a href="#">
                        <i class="fas fa-tv"></i> <span>Monitoração</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fas fa-money-bill-alt"></i> <span>Planos de Contrato</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
